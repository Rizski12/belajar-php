    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <form action="../pages/login/login_proses.php" method="post" onsubmit="return validateForm()">
                ...
                <div class="row">
                    <small>Don't have account? <a href="pages/login/register.php">Sign Up</a></small>
                </div>
