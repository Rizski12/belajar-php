...
<div class="wrapper">
  ...
  <div class="produk-container mt-2">
    <?php 
    include 'array-produk.php';

    foreach ($produk as $item) {
        echo '<div class="card ml-4" style="width: 17rem;">';
        echo '<span class="badge-produk">' . $item['badge'] . '</span>';
        echo '<img src="' . $item['gambar'] . '" alt="' . $item['nama'] . '" class="card-img-top" >';
        echo '<div class="card-body">';
        echo '<h4 class="card-title">' . $item['nama'] . '</h4>';
        echo '<br>';
        echo '<p class="deskripsi">' . $item['deskripsi'] . '</p>';
        echo '<p class="toko"><strong>' . $item['toko'] . '</strong></p>';
